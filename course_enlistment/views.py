...
from .models import Course, Module, Content, UserProgress, Enrollment
...
def module_detail(request, module_id):
    ...
    return render(request, 'courses/module_detail.html', {'module': module, 'contents': contents})
...
def track_module_progress(request, module_id):
    ...
    return render(request, 'courses/module_progress.html', {'module': module, 'progress_percentage': progress_percentage})
